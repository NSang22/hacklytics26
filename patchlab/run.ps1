# PatchLab — Run Script (PowerShell)
# Start backend + frontend + game server + desktop capture agent

Write-Host "=== PatchLab ===" -ForegroundColor Cyan
...
Write-Host "[4/4] Launching PatchLab Desktop Capture Agent..." -ForegroundColor Yellow
...
Write-Host "  Desktop:   PatchLab Desktop Capture Agent (GUI)"
