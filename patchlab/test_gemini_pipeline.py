...
DFA_STATES = [
    {
        ...
        "description": "Opening run — flat ground, first Goomba, ? blocks. Fast-paced intro.",
        "visual_cues": ["green grass", "blue sky", "Mario sprite", "Question blocks", "Goomba"],
        "intended_emotion": "excited",
        "acceptable_range": [0.3, 0.8],
        "expected_duration_sec": 8,
    },
    {
        "name": "platforming",
        "description": "Pipes, pits, and enemies. Deaths send player back to start; single deaths are normal, only excessive deaths signal a problem.",
        "visual_cues": ["gap in floor", "green pipes", "Koopas", "piranha plants"],
...
def main():
    print("=" * 60)
    print("PatchLab — Gemini Vision Pipeline Test")
    print("=" * 60)
